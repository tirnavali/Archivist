...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference("Vacation.count") do
      post vacations_url, params: { vacation: { ending_date: @vacation.ending_date, explanation: @vacation.explanation, starting_date: @vacation.starting_date, user_id: @vacation.user_id } }
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { ending_date: @vacation.ending_date, explanation: @vacation.explanation, starting_date: @vacation.starting_date, user_id: @vacation.user_id } }
